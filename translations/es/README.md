...
[![Unirse al Discord de AI Foundry](https://img.shields.io/badge/Discord-AI_Community-blue?style=flat-square&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

🎯 [Qué aprenderás](#qué-aprenderás) &ensp; ✅ [Requisitos](#requisitos) &ensp; 🤖 [Entendiendo la familia GitHub Copilot](#entendiendo-la-familia-github-copilot) &ensp; 📚 [Estructura del curso](#estructura-del-curso) &ensp; 📋 [Referencia de comandos](#referencia-de-comandos-de-github-copilot-cli)
...
- **Usuarios de terminal** que prefieren flujos de trabajo dirigidos por teclado frente a integraciones de IDE
...
- **Conceptos básicos de terminal**: Familiarizado con `cd`, `ls`, y ejecutar comandos

## 🤖 Entendiendo la familia GitHub Copilot

GitHub Copilot ha evolucionado hacia una familia de herramientas impulsadas por IA. Aquí es donde se encuentra cada una:
...
Este curso se centra en **GitHub Copilot CLI**, trayendo asistencia de IA directamente a tu terminal.
...
| 06 | 🔌 [Conectar con GitHub, bases de datos y APIs](./06-mcp-servers/README.md) | Integración con servidores MCP |
...
2. Crea una rama para la característica (`git checkout -b my-improvement`)
