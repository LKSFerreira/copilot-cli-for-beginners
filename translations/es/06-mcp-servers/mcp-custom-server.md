...
¿Quieres conectar Copilot a tus propias APIs? Aquí se explica cómo crear un servidor MCP sencillo en Python que busca información de libros, enlazando con el proyecto de aplicación de libros que has estado usando a lo largo de este curso.
...
1. **Agregar más herramientas** - Cada función `@mcp.tool()` se convierte en una herramienta que Copilot puede llamar
