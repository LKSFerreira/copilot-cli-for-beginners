...
>
> ⚠️ **Este apéndice es para equipos con pipelines de CI/CD existentes.** Si eres nuevo en GitHub Actions o en los conceptos de CI/CD, comienza con el enfoque más sencillo del hook pre-commit en la sección [Automatización de revisión de código](../07-putting-it-together/README.md#workflow-3-code-review-automation-optional) del Capítulo 07.

Este apéndice muestra cómo integrar GitHub Copilot CLI en tus pipelines de CI/CD para la revisión automatizada de código en solicitudes de extracción (pull requests).

---

## Flujo de trabajo de GitHub Actions

Este flujo de trabajo revisa automáticamente los archivos cambiados cuando se abre o actualiza una solicitud de extracción (pull request):
...
Para revisiones coherentes en todo tu equipo, crea una configuración compartida:
...
1. **Usar el indicador `--silent`** - Suprime la salida de progreso para obtener registros más limpios
2. **Establecer tiempos de espera** - Evita que las revisiones colgadas bloqueen tu pipeline
3. **Filtrar tipos de archivos** - Revisa solo archivos relevantes (omite código generado, dependencias)
4. **Conciencia del límite de tasa** - Espacia las revisiones para PRs grandes
