...
> **Nota**: La muestra principal para este curso es la **aplicación de colección de libros en Python** en `../book-app-project/`. Estos archivos JS/React provienen de una versión anterior del curso y se conservan como material de referencia opcional adicional para estudiantes que quieran ejemplos en JS.

Esta carpeta contiene archivos de código fuente de ejemplo. Estos son solo ejemplos y no están pensados para ser una aplicación completamente funcional.
...
Estos archivos son referenciados en los ejemplos del curso usando la sintaxis `@`:
