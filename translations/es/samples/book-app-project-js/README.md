...
* Lee los libros desde un archivo JSON (nuestra base de datos)
* La comprobación de entrada es débil en algunas áreas
...
* `book_app.js` - Punto de entrada principal del CLI
* `books.js` - Clase BookCollection con la lógica de datos
* `utils.js` - Funciones auxiliares para la interfaz y la entrada
* `data.json` - Datos de ejemplo de libros
* `tests/test_books.js` - Pruebas iniciales usando el corredor de pruebas integrado de Node
